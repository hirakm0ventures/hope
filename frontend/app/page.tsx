...
const routes = [
  { href: "/booking", label: "Booking", description: "Browse and book available event slots" },
...
export default function Home() {
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
      ...
      <p className="text-gray-500 mb-12 text-lg">Waitlist &amp; Capacity Engine</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl">
        {routes.map(({ href, label, description }) => (
          ...
          >
            <h2 className="text-xl font-semibold text-gray-800 mb-1">{label}</h2>
